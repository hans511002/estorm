...
public class ZkState {
	public static final Log LOG = LogFactory.getLog(ZkState.class);
	...
	private CuratorFramework newCurator(Map stateConf) throws Exception {
		...
		return CuratorFrameworkFactory.newClient(
				...
				15000,
				new RetryNTimes(Utils.getInt(stateConf.get(Config.STORM_ZOOKEEPER_RETRY_TIMES)), Utils.getInt(stateConf
