...
public class IOUtils {
	 ...
	 * @param close
	 *            whether or not close the InputStream and OutputStream at the end. The streams are closed in the finally clause.
	 */
	 ...
	 */
	public static void copyBytes(InputStream in, OutputStream out, final long length, final int bufferSize, final boolean close)
			throws IOException {
	...
	/**
	 * Utility wrapper for reading from {@link InputStream}. It catches any errors thrown by the underlying stream (either IO or
