...
public abstract class Hash {
	...
	/**
	 * This utility method converts String representation of hash function name to a symbolic constant. Currently two function types are
	 * supported, "jenkins" and "murmur".
	 * 
	 * @param name
	 *            hash function name
	...
	/**
	 * Calculate a hash using bytes from 0 to <code>length</code>, and the provided seed value
	 * 
	 * @param bytes
	 *            input bytes
	 * @param length
