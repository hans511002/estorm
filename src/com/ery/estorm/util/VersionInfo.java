...
import com.ery.estorm.VersionAnnotation;

/**
 * This class finds the package info for hbase and the VersionAnnotation information. Taken from hadoop. Only name of annotation is
 * different.
 */
public class VersionInfo {
	...
	public static String[] versionReport() {
		return new String[] { "EStorm " + getVersion(), "Subversion " + getUrl() + " -r " + getRevision(),
